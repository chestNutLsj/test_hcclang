...
from .ir import *
from .passes import *
from .tb_assignment import *
from .chunk import *
from .buffer import *
from .rank_dag import *
...
class HCCLProgram:
    ...
    def __enter__(self):
        global _current_program
        if _current_program != None:
            raise RuntimeError("There is already a HCCL Program in context")
    ...
    def lower(self):
        ...
        if self.check_xml:
            # Check generated HCCL-IR for correctness - no circular dependencies, sends and receives are ordered
