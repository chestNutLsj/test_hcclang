...
HcclResult CollAllGatherRingExecutor::KernelRun(const OpParam &param, ExecMem &execMem)
{
    ...
    CHK_RET(MultRingAllGather(param.tag, execMem.inputMem, currentOutputMem, execMem.count, param.DataDes.dataType,
...
HcclResult CollAllGatherRingExecutor::MultRingAllGather(const std::string &tag, DeviceMem inputMem, DeviceMem outputMem,
