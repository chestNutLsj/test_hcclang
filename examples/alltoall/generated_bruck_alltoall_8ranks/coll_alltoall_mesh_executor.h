...
#ifndef ALLTOALL_MESH_H
#define ALLTOALL_MESH_H

#include "coll_alltoall_executor.h"

namespace hccl {
class AlltoallMesh : public CollAlltoallExecutor {
public:
    explicit AlltoallMesh(const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~AlltoallMesh() = default;
...
private:
    ...
    HcclResult PrepareAlltoallSlice(u32 sliceNum, u64 inputMemSize,
        std::vector<Slice> &dataSegsSlice) const;
};

} // namespace hccl

#endif /* ALLTOALL_MESH_H */