...
namespace hccl {
class AllgatherRing : public CollAllgatherExecutor {
public:
    explicit AllgatherRing(const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~AllgatherRing() = default;
