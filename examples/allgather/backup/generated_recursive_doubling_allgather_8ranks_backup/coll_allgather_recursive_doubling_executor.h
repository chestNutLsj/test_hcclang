...
#ifndef ALLGATHER_RECURSIVE_DOUBLING_H
#define ALLGATHER_RECURSIVE_DOUBLING_H

#include "coll_allgather_executor.h"

namespace hccl {
class AllgatherRecursiveDoubling : public CollAllgatherExecutor {
public:
    explicit AllgatherRecursiveDoubling(const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~AllgatherRecursiveDoubling() = default;
...
#endif /* ALLGATHER_RECURSIVE_DOUBLING_H */