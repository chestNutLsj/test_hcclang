...
#ifndef ALLGATHER_RECURSIVE_DOUBLING_H_PUB_H
#define ALLGATHER_RECURSIVE_DOUBLING_H_PUB_H

#include "alg_template_base_pub.h"

namespace hccl {
class AllgatherRecursiveDoubling : public AlgTemplateBase {
public:
    explicit AllgatherRecursiveDoubling(const HcclDispatcher dispatcher);
    ~AllgatherRecursiveDoubling() override;
...
#endif /* ALLGATHER_RECURSIVE_DOUBLING_H_PUB_H */